      ...
      <section id="detail">
        <div class="detail-container">
          ...
          <div class="detail-container-right">
            <i" class="fa fa-heart js-click-favorite <?php if(isFavorite($_SESSION['user_id'], $viewData['id'])) echo 'favorite-active'; ?>" aria-hidden="true" data-productid="<?php echo $viewData['id']; ?>"></i">
